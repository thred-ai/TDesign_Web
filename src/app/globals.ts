...
export class Globals {
  public static ngrokId = 'b3b8-2607-fea8-7ddd-3900-5910-671b-cb5b-adb3.ngrok.io';
  ...
  public static matchingProvince(a: string) {
    return this.caProvinces.find((p) => {
      return (
        p.name.toLowerCase() == a.trim().toLowerCase() ||
        p.abbreviation.toLowerCase() == a.trim().toLowerCase()
      );
    });
  }
