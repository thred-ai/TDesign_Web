...
export declare class AngularFaviconService implements OnDestroy {
    ...
    private renderer;
    constructor(_doc: any, rendererFactory: RendererFactory2);
    private darkScheme;
    ...
    ngOnDestroy(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<AngularFaviconService, never>;
}

//# sourceMappingURL=angular-favicon.service.d.ts.map